  ...
  return (
    <div className='dashboard-banner'>
      <div className='dashboard-banner_content'>
        <div className='dashboard-banner_content_left'>
          {
            banner_data && banner_data.content && (
              <img
                src={getIPFSFile(banner_data.content.photo)}
              />
            )
          }
          {
            ...
            <div className='dashboard-banner_content_right'>
              <div className='justine_dusk'>
                <p className='token_address'>
                  <span><FormattedMessage id='dashboard6' /></span>
                ...
                <p className='describe'>
                  <Typewriter speed={15} showSubscript start={true} text={banner_data.content.introduction} />
                </p>
              </div>
            </div>
          )
       ...
       {
          !(banner_data && banner_data.content) && (<div className='dashboard-banner_content_right'>
            <h3><FormattedMessage id='dashboard' /></h3>
            <img className='line' src={require(`../../../assets/image/dashboard/line@2x.png`).default} />

            {/* <div className='get_nft'>
            <div className='get_nft_one'>
              <p>
                <span>2</span>
                <FormattedMessage id='dashboard3' />
              </p>
              <a>
